// Icon Renderer - Local SVG icons to replace CDN dependency
// Provides common icons for widgets and themes

(function () {
    // Bundled SVG icons (common icons for dashboard widgets)
    const icons = {
        ...
        pencil: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="2" x2="22" y2="6"></line><path d="M7.5 20.5 19 9l-4-4L3.5 16.5 2 22z"></path></svg>',
    ...
    const iconRenderer = {
        ...
        getIcon(name, props = {}) {
            ...
            const { size = 24, className = '', color } = props;
        ...
        /**
         * Render an icon directly to a container
         * @param {string} name - Icon name
         * @param {HTMLElement} container - Container element
         * @param {Object} props - Optional properties
         */
        renderTo(name, container, props = {}) {
            const svg = this.getIcon(name, props);
            if (svg && container) {
         ...
         */
        hydrateIcons(container = document) {
            ...
            elements.forEach(el => {
                ...
                const svg = this.getIcon(name, { size, className });
                if (svg) {
                    el.outerHTML = svg;
                }
            });
        ...
        /**
         * Check if an icon exists in the bundle
         * @param {string} name - Icon name
         * @returns {boolean}
         */
        hasIcon(name) {
        ...
        /**
         * Add a custom icon to the bundle
         * @param {string} name - Icon name
    ...
    // Also expose as lucide-compatible API for backwards compatibility
    window.lucide = window.lucide || {
        createIcons: () => iconRenderer.hydrateIcons()
    };
})();
